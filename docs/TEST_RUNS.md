...
- Results:
  ...
  - Added a login-gated Android APK install page/QR and kit artifact `handoffUrl` fields so physical Android handoff can start from production Settings without making wrapper artifacts public.
