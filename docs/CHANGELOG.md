...
- Added a login-gated Android APK install page/QR with release verification link creation to Settings and verification-kit artifact handoff URLs to make physical Android wrapper handoff easier without making wrapper artifacts public.
