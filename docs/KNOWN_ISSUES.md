...
- The Capacitor Android wrapper now builds a debug APK on the server, but it still needs a physical Android device run; iOS still needs a macOS/iOS toolchain.
