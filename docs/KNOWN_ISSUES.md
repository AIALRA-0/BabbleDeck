...
- `pnpm device:readiness:production` currently reports no connected physical Android device, no macOS/Xcode host for iOS, and no interactive desktop display session.
